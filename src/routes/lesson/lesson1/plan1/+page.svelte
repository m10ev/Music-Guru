	...
	<div class="  h-[450px] w-[]  mt-16 grid grid-flow-col gap-4  flex-auto  pt   ">
		<div class="bg-slate-100 rounded-lg text-center items-center ">
			<span class="text-center text-2xl font-bold font-mono pt    "
				>Whole <span class="text-blue-600">Notes</span></span
			>
		</div>

		<div class="border- border-gray-500 bg-slate-100 text-center rounded-lg ">
			<span class="text-center text-2xl font-bold  font-mono pt    "
				>Half <span class="text-blue-600">Notes</span></span
			>
		</div>

		<div class="bg-slate-100 rounded-lg text-center">
			<span class="text-center text-2xl font-bold font-mono pt    "
				>Quater <span class="text-blue-600">Notes</span></span
			>
		</div>
	</div>
